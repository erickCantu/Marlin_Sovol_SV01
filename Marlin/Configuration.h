...
#define STRING_CONFIG_H_AUTHOR "(Erick, Sovol SV01, 3DTouch, SKR 1.4Turbo, TMC2209, TriangleLab Nema17_23-TitanExtruder )" // ECP // Who made the changes.
#define CUSTOM_VERSION_FILE Version.h // Path from the root directory (no quotes)

// @section custom
#define SV01_3DTOUCH // ECP (Based in Sovol 2.1.5 conf.)  Enable for 3D Touch / BLTouch 
...
#define SHOW_CUSTOM_BOOTSCREEN //ECP

// Show the bitmap in Marlin/_Statusscreen.h on the status screen.
#define CUSTOM_STATUS_SCREEN_IMAGE //ECP

// @section machine

// Choose the name from boards.h that matches your setup
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_SKR_V1_4_TURBO // ECP
#endif
 ...
 * :[-2, -1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT_2 0 // ECP Setup the TFT Display 
...
#define CUSTOM_MACHINE_NAME "SV01 - SKR 1.4T" //ECP

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "ec897f17-168b-4bf0-96c0-9381fadf2ec2" //ECP
 ...
 */
#define X_DRIVER_TYPE  TMC2209 //ECP
#define Y_DRIVER_TYPE  TMC2209 //ECP
...
#define E0_DRIVER_TYPE TMC2209 //ECP
 ...
 */
#define PIDTEMPBED //ECP

#if ENABLED(PIDTEMPBED)
  //#define MIN_BED_POWER 0
  #define PID_BED_DEBUG //ECP // Print Bed PID debug data to the serial port.
...
// @section pid temp
  ...
  #define PID_EDIT_MENU  //ECP        // Add PID editing to the "Advanced Settings" menu. (~700 bytes of flash)
  #define PID_AUTOTUNE_MENU //ECP    // Add PID auto-tuning to the "Advanced Settings" menu. (~250 bytes of flash)
#endif
...
#define X_MIN_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop. //ECP keep False for sensorless homing
#define Y_MIN_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop. //ECP keep False for sensorless homing
...
* The titan extruder gear ratio is 1:3
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 5, 25 } //ECP Sovol Documentation
 ...
 */
#define DEFAULT_ACCELERATION           750    // ECP (Based in Sovol 2.1.5 conf.) X, Y, Z and E acceleration for printing moves
#define DEFAULT_RETRACT_ACCELERATION   750    // ECP (Based in Sovol 2.1.5 conf.) E acceleration for retracts
#define DEFAULT_TRAVEL_ACCELERATION   1000    // ECP (Based in Sovol 2.1.5 conf.) X, Y, Z acceleration for travel (non printing) moves
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.06 // ECP (Based in Sovol 2.1.5 conf.) (mm) Distance from real junction edge
 ...
 */
#define S_CURVE_ACCELERATION // ECP (Based in Sovol 2.1.5 conf.) 
 ...
 */
#define FILAMENT_RUNOUT_SENSOR // ECP (Based in Sovol 2.1.5 conf.) 
...
#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 5 // 3 ECP for convenience 
  #define GRID_MAX_POINTS_Y 4// GRID_MAX_POINTS_X // ECP for convenience 
 ...
 */
#define LCD_BED_LEVELING  // ECP for convenience 
...
#define LCD_BED_TRAMMING  // ECP for convenience 
 ...
 */
#define EEPROM_SETTINGS     // Persistent storage with M500 and M501 // ECP for convenience 
...
#define PREHEAT_1_TEMP_HOTEND 215  // ECP for convenience 
...
#define PREHEAT_3_LABEL       "PTEG" // ECP for convenience 
#define PREHEAT_3_TEMP_HOTEND 230    // ECP for convenience 
#define PREHEAT_3_TEMP_BED    70     // ECP for convenience 
#define PREHEAT_3_TEMP_CHAMBER 35    // ECP for convenience 
#define PREHEAT_3_FAN_SPEED     0 // Value from 0 to 255 // ECP for convenience
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MAX_POS - 10), (Y_MIN_POS + 10), 20 }  // Based in Chris Basement setup
 ...
 */
#define PRINTCOUNTER   // ECP Adjusted after (Based in Sovol 2.1.5 conf.) 
 ...
 */
#define SDSUPPORT   // ECP Adjusted after (Based in Sovol 2.1.5 conf.) 
...
//
#define SPEAKER   // ECP Adjusted after (Based in Sovol 2.1.5 conf.) 
...
//
#define REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER  // ECP Per BTT git hub. https://github.com/erickCantu/BIGTREETECH-TouchScreenFirmware
                                                       // It is also the default with Sovol display.    
//
...
#define FAN_SOFT_PWM   // ECP Adjusted after (Based in Sovol 2.1.5 conf.) 
