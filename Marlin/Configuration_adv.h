 ...
 */
#define E0_AUTO_FAN_PIN P2_04 // ECP Based in Chris Basement setup
...
#define SENSORLESS_BACKOFF_MM  { 2, 2, 0 }  // (linear=mm, rotational=°) Backoff from endstops before sensorless homing // ECP after https://reprap.org/forum/read.php?415,893568,893658#msg-893658
...
// @section bltouch
   ...
   */
  #if ENABLED(SV01_3DTOUCH)       // ECP Adjusted after (Based in Sovol 2.1.5 conf.) 
    #define BLTOUCH_HS_MODE true  // ECP Adjusted after (Based in Sovol 2.1.5 conf.) 
  #endif                          // ECP Adjusted after (Based in Sovol 2.1.5 conf.) 
...
#define Z_STEPPER_AUTO_ALIGN  //ECP per https://www.youtube.com/watch?v=3jAFQdTk8iw&list=PLe7L6YFPoKLfXi71zcbaDrJ_6dPV9yJs-&index=43
   ...
   */
  #define Z_STEPPER_ALIGN_XY { { 35, 125 }, { 245,  125 }} //ECP per https://www.youtube.com/watch?v=3jAFQdTk8iw&list=PLe7L6YFPoKLfXi71zcbaDrJ_6dPV9yJs-&index=43
  ...
  #define Z_STEPPER_ALIGN_ITERATIONS 10    // Number of iterations to apply during alignment //ECP Add More iterations as it is needed in this machine. 
  #define Z_STEPPER_ALIGN_ACC        0.01 // Stop iterating early if the accuracy is better than this //ECP Tight the accuracy, it is possible to achieve it. Provides printing stability.
 ...
 */
#define ADAPTIVE_STEP_SMOOTHING  // ECP Adjusted after (Based in Sovol 2.1.5 conf.) 
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define STATUS_MESSAGE_SCROLLING   // ECP Adjusted after (Based in Sovol 2.1.5 conf.) 
...
#define SET_PROGRESS_MANUALLY   // ECP Adjusted after (Based in Sovol 2.1.5 conf.) 
#if ENABLED(SET_PROGRESS_MANUALLY)
  #define SET_PROGRESS_PERCENT            // Add 'P' parameter to set percentage done
  //#define SET_REMAINING_TIME              // Add 'R' parameter to set remaining time  // ECP Adjusted after (Based in Sovol 2.1.5 conf.) 
...
// LCD Print Progress options. Multiple times may be displayed in turn.
   ...
   */
  #define SDCARD_CONNECTION LCD  // ECP
 ...
 */
#define BABYSTEPPING   // ECP Adjusted after (Based in Sovol 2.1.5 conf.) 
  ...
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING  // Double-click on the Status Screen for Z Babystepping. // ECP Based in Chris Basement setup
  ...
  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping  // ECP Based in Chris Basement setup
...
#define LIN_ADVANCE  // ECP per https://www.youtube.com/watch?v=V-bKfYF3I-o
  ...
  #else
    #define ADVANCE_K 0        // (mm) Compression length applying to all extruders // ECP per https://www.youtube.com/watch?v=V-bKfYF3I-o
  #endif
 ...
 */
#define ADVANCED_PAUSE_FEATURE   // ECP Adjusted after (Based in Sovol 2.1.5 conf.) 
 ...
 */
   ...
   */
  #define MONITOR_DRIVER_STATUS   // ECP Based in Chris Basement setup
   ...
   */
  #define SENSORLESS_HOMING // StallGuard capable drivers only  // ECP Based in Chris Basement setup
   ...
   */
  #define TMC_DEBUG  // ECP Based in Chris Basement setup
 ...
 */
#define HOST_ACTION_COMMANDS // ECP Enabled for Octoprint
